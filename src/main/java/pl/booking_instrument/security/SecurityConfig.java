package pl.booking_instrument.security;
...
import pl.booking_instrument.user.ApplicationUserDetailsService;

import java.util.concurrent.TimeUnit;

import static pl.booking_instrument.user.model.UserRoleEnum.ADMIN;
